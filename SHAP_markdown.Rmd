...
We examine the models' outputs using a hold out test dataset (15% of available observations) and applying a model_evalulation function for further statistics. It lets us view: the obtained loss (MSE, MAE, Poisson Deviance); prediction statistics grouped by the actual claim number and raw predictions. Further details on model_evaluation function along with the source code can be found in section 4.1 \
